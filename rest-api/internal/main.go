...
import (
	"fmt"
	"github.com/antunesgabriel/golang-examples/rest-api/pkg/swagger/server/restapi"
	"github.com/antunesgabriel/golang-examples/rest-api/pkg/swagger/server/restapi/operations"
	"log"
	"net/http"
